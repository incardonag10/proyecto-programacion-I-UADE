...
if __name__ == "__main__":
    while True:
        ...
        while saldo > 0:
            ...
            if saldo <= 0:
                print("Te quedaste sin saldo. Tenes que crear un nuevo usuario.")
                break

            respuesta = input("Queres jugar otra partida? (si/no): ").strip().lower()

            if respuesta != "si":
                print(f"Gracias por jugar. Tu saldo final es {saldo}.")
                break
